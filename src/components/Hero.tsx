    ...
    return (
        ...
        >
            ...
            <div className="relative z-20 flex flex-col items-center gap-8 text-center max-w-6xl pb-24">
                ...
                >
                    {/* Индикатор звука (парит рядом) */}
                    <div className={cn(
                        "absolute top-0 -right-4 z-30 flex h-14 w-14 items-center justify-center rounded-full bg-white/90 backdrop-blur-sm shadow-lg transition-all duration-300 group-hover:scale-110",
                        isPlaying ? "animate-pulse ring-4 ring-blue-400/50" : "ring-2 ring-slate-200"
                    )}>
                    ...
                    >
                        <img
                            ...
                            alt="Путешественник"
                            className={cn(
                                "h-auto w-full max-w-4xl object-contain drop-shadow-2xl transition-all duration-700",
                        ...
                        <div className={cn(
                            "absolute inset-0 bg-blue-400/20 blur-[100px] -z-10 transition-opacity duration-500 rounded-full",
            ...
            {/* 3. СТАТИЧНАЯ СТРЕЛКА (вне блока контента для точности позиционирования) */}
            <div
                ref={arrowRef}
                className="absolute bottom-0 left-1/2 -translate-x-1/2 z-20 pb-8 flex flex-col items-center opacity-40 pointer-events-none"
            >
                <svg
